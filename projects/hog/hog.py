...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    ten_opp = (opponent_score - opponent_score // 100 * 100) // 10
    point_player = player_score % 10
    return max(3 * abs(ten_opp - point_player),1)
...
simple_update(8,15,10,make_test_dice(2, 1, 6, 6, 6, 5, 4, 4))
